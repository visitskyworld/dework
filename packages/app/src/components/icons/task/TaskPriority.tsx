...
const IconMapping: Record<TaskPriority, (size: number) => ReactElement> = {
  [TaskPriority.URGENT]: (size) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 15 15"
...
export const TaskPriorityIcon: FC<Props> = ({ priority, size = 20 }) =>
  IconMapping[priority](size);
